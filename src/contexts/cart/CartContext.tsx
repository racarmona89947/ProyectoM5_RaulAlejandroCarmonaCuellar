...
export function CartProvider({ children }: CartProviderProps) {
  ...
  const storageKey = firebaseUser
    ? `${CART_STORAGE_KEY}-${firebaseUser.uid}`
    : null;
  ...
  useEffect(() => {
    ...
    if (canUseCloudUserData && firebaseUser)
      void saveCloudCart(firebaseUser.uid, state.items).catch(() => undefined);
